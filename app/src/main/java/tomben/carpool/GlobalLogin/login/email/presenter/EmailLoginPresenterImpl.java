package tomben.carpool.GlobalLogin.login.email.presenter;

import android.util.Log;

import com.example.benjaminlize.loginapp.GlobalLogin.login.email.interactor.EmailLoginInteractor;
import com.example.benjaminlize.loginapp.GlobalLogin.login.email.interactor.EmailLoginInteractorImpl;
import com.example.benjaminlize.loginapp.GlobalLogin.login.email.view.EmailLoginFragmentView;
import com.example.benjaminlize.loginapp.GlobalLogin.login.email.view.LoginActivityFragment;
